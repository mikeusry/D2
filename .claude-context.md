...
<!-- Product Thumbnail -->
<CloudinaryImage
  publicId="d2-sanitizers/sanitizer-bottle"
...
<CloudinaryImage
  publicId="d2-sanitizers/facility-tour"
  alt="Facility tour"
  width={800}
  aspectRatio="16/9"
  class="w-full"
...
**IMPORTANT:** All D2 Sanitizers assets are stored in the `d2-sanitizers/` folder in Cloudinary. Always prefix your publicId with `d2-sanitizers/` unless instructed otherwise.
