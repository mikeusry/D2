...
function extractProductMetadata(page, url) {
    ...
    async requestHandler({ request, page, enqueueLinks, log }) {
        ...
        try {
            ...
            await page.waitForLoadState('networkidle').catch(() => {
                // Fallback if waitForLoadState doesn't work
                return new Promise(resolve => setTimeout(resolve, 3000));
            });

            // Extract basic metadata
            const baseMetadata = extractProductMetadata(page, url);
            ...
            // Find and download documents (PDFs, docs, etc.)
